...
var Parser = (function() {
    ...
    parser.prototype = new waxeye.WaxeyeParser(0, true, [new waxeye.FA("kevScript", [new waxeye.State([new waxeye.Edge(39, 1, false)], false),
        ...
        new waxeye.FA("line", [new waxeye.State([new waxeye.Edge(41, 1, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 2, false)], false),
            new waxeye.State([new waxeye.Edge(40, 3, false)], true),
        ...
        new waxeye.FA("realString", [new waxeye.State([new waxeye.Edge(["\'"], 1, true),
            ...
            new waxeye.State([new waxeye.Edge(43, 5, false)], false),
            new waxeye.State([new waxeye.Edge(24, 1, false),
                new waxeye.Edge(-1, 1, false)], false),
            new waxeye.State([], true),
            new waxeye.State([new waxeye.Edge(["\\"], 8, false),
                new waxeye.Edge(47, 10, false),
                new waxeye.Edge(["\""], 6, true)], false),
            new waxeye.State([new waxeye.Edge(45, 9, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 7, false)], false),
            new waxeye.State([new waxeye.Edge(46, 11, false)], false),
            new waxeye.State([new waxeye.Edge(24, 7, false),
                new waxeye.Edge(-1, 7, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("realStringNoNewLine", [new waxeye.State([new waxeye.Edge(["\'"], 1, true),
                new waxeye.Edge(["\""], 8, true)], false),
            new waxeye.State([new waxeye.Edge(["\\"], 2, false),
                new waxeye.Edge(51, 4, false),
                new waxeye.Edge(["\'"], 7, true)], false),
            new waxeye.State([new waxeye.Edge(48, 3, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 1, false)], false),
            new waxeye.State([new waxeye.Edge(50, 5, false)], false),
            new waxeye.State([new waxeye.Edge(49, 6, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 1, false)], false),
            new waxeye.State([], true),
            new waxeye.State([new waxeye.Edge(["\\"], 9, false),
                new waxeye.Edge(55, 11, false),
                new waxeye.Edge(["\""], 7, true)], false),
            new waxeye.State([new waxeye.Edge(52, 10, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 8, false)], false),
            new waxeye.State([new waxeye.Edge(54, 12, false)], false),
            new waxeye.State([new waxeye.Edge(53, 13, false)], false),
