...
var Parser = (function() {
    ...
    parser.prototype = new waxeye.WaxeyeParser(0, true, [new waxeye.FA("kevScript", [new waxeye.State([new waxeye.Edge(42, 1, false)], false),
            new waxeye.State([new waxeye.Edge(1, 2, false),
                new waxeye.Edge(39, 6, true)], false),
            new waxeye.State([new waxeye.Edge(42, 3, false)], false),
            new waxeye.State([new waxeye.Edge(1, 4, false),
                new waxeye.Edge(39, 5, true)], true),
            new waxeye.State([new waxeye.Edge(42, 3, false)], false),
            new waxeye.State([new waxeye.Edge(40, 4, false)], true),
            new waxeye.State([new waxeye.Edge(40, 2, false)], false)], waxeye.FA.LEFT),
        ...
        new waxeye.FA("add", [new waxeye.State([new waxeye.Edge(29, 1, false)], false),
            ...
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("remove", [new waxeye.State([new waxeye.Edge(30, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("move", [new waxeye.State([new waxeye.Edge(31, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(42, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("attach", [new waxeye.State([new waxeye.Edge(33, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(42, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("detach", [new waxeye.State([new waxeye.Edge(34, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(42, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("set", [new waxeye.State([new waxeye.Edge(32, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            ...
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("network", [new waxeye.State([new waxeye.Edge(35, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(16, 3, false)], false),
            new waxeye.State([new waxeye.Edge(42, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("addBinding", [new waxeye.State([new waxeye.Edge(36, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(16, 3, false)], false),
            new waxeye.State([new waxeye.Edge(42, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("delBinding", [new waxeye.State([new waxeye.Edge(37, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(16, 3, false)], false),
            new waxeye.State([new waxeye.Edge(42, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("addRepo", [new waxeye.State([new waxeye.Edge(27, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("include", [new waxeye.State([new waxeye.Edge(28, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
        ...
        new waxeye.FA("typeDef", [new waxeye.State([new waxeye.Edge(18, 1, false)], false),
            ...
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("namespace", [new waxeye.State([new waxeye.Edge(38, 1, false)], false),
            new waxeye.State([new waxeye.Edge(42, 2, false)], false),
            new waxeye.State([new waxeye.Edge(18, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        ...
        new waxeye.FA("escaped1", [new waxeye.State([new waxeye.Edge(["\'"], 1, false),
                new waxeye.Edge("\\", 1, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("escaped2", [new waxeye.State([new waxeye.Edge(["\""], 1, false),
                new waxeye.Edge("\\", 1, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("notEscaped1Line", [new waxeye.State([new waxeye.Edge(48, 1, false)], false),
            new waxeye.State([new waxeye.Edge(47, 2, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 3, false)], false),
            new waxeye.State([new waxeye.Edge(46, 4, false)], true),
            new waxeye.State([new waxeye.Edge(45, 5, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 3, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("notEscaped2Line", [new waxeye.State([new waxeye.Edge(52, 1, false)], false),
            new waxeye.State([new waxeye.Edge(51, 2, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 3, false)], false),
            new waxeye.State([new waxeye.Edge(50, 4, false)], true),
            new waxeye.State([new waxeye.Edge(49, 5, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 3, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("realString", [new waxeye.State([new waxeye.Edge(["\""], 1, true),
            ...
            new waxeye.State([new waxeye.Edge("\\", 2, true),
                new waxeye.Edge(25, 1, false),
                new waxeye.Edge(53, 3, false),
                new waxeye.Edge(["\""], 4, true)], false),
            new waxeye.State([new waxeye.Edge(23, 1, false)], false),
            new waxeye.State([new waxeye.Edge(41, 1, false)], false),
            new waxeye.State([], true),
            new waxeye.State([new waxeye.Edge("\\", 6, true),
                new waxeye.Edge(24, 5, false),
                new waxeye.Edge(54, 7, false),
                new waxeye.Edge(["\'"], 4, true)], false),
            new waxeye.State([new waxeye.Edge(22, 5, false)], false),
            new waxeye.State([new waxeye.Edge(41, 5, false)], false)], waxeye.FA.LEFT),
        ...
        new waxeye.FA("eol", [new waxeye.State([new waxeye.Edge("\r", 1, false),
            ...
            new waxeye.State([], true)], waxeye.FA.VOID),
        new waxeye.FA("eolKept", [new waxeye.State([new waxeye.Edge("\r", 1, false),
                new waxeye.Edge("\n", 2, false),
                new waxeye.Edge("\r", 2, false)], false),
            new waxeye.State([new waxeye.Edge("\n", 2, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("ws", [new waxeye.State([new waxeye.Edge(["\t", " "], 0, false),
                new waxeye.Edge(40, 0, false)], true)], waxeye.FA.VOID),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(40, 1, false)], false),
            new waxeye.State([], true)], waxeye.FA.NEG),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(40, 1, false)], false),
            new waxeye.State([], true)], waxeye.FA.NEG),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(40, 1, false)], false),
            new waxeye.State([], true)], waxeye.FA.NEG),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(22, 1, false)], false),
            new waxeye.State([], true)], waxeye.FA.NEG),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(40, 1, false)], false),
            new waxeye.State([], true)], waxeye.FA.NEG),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(22, 1, false)], false),
