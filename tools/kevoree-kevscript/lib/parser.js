...
var Parser = (function() {
    ...
    parser.prototype = new waxeye.WaxeyeParser(0, true, [new waxeye.FA("kevScript", [new waxeye.State([new waxeye.Edge(48, 1, false)], false),
            new waxeye.State([new waxeye.Edge(1, 2, false),
                new waxeye.Edge(46, 3, true)], true),
            new waxeye.State([new waxeye.Edge(48, 1, false)], false),
            new waxeye.State([new waxeye.Edge(47, 2, false)], true)], waxeye.FA.LEFT),
        ...
        new waxeye.FA("add", [new waxeye.State([new waxeye.Edge(33, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(":", 5, true)], false),
            new waxeye.State([new waxeye.Edge(48, 6, false)], false),
            new waxeye.State([new waxeye.Edge(14, 7, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("remove", [new waxeye.State([new waxeye.Edge(34, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("move", [new waxeye.State([new waxeye.Edge(35, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("attach", [new waxeye.State([new waxeye.Edge(37, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("detach", [new waxeye.State([new waxeye.Edge(38, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("set", [new waxeye.State([new waxeye.Edge(36, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(19, 3, false)], false),
            new waxeye.State([new waxeye.Edge("/", 4, true),
                new waxeye.Edge(48, 6, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([new waxeye.Edge(48, 6, false)], false),
            new waxeye.State([new waxeye.Edge("=", 7, true)], false),
            new waxeye.State([new waxeye.Edge(48, 8, false)], false),
            new waxeye.State([new waxeye.Edge(25, 9, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("network", [new waxeye.State([new waxeye.Edge(39, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(19, 3, false)], false),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(22, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("addBinding", [new waxeye.State([new waxeye.Edge(40, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(19, 3, false)], false),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("delBinding", [new waxeye.State([new waxeye.Edge(41, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(19, 3, false)], false),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("addRepo", [new waxeye.State([new waxeye.Edge(31, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(29, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("include", [new waxeye.State([new waxeye.Edge(32, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(21, 3, false)], false),
            new waxeye.State([new waxeye.Edge(":", 4, true)], false),
            new waxeye.State([new waxeye.Edge(22, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("nameList", [new waxeye.State([new waxeye.Edge(19, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge([","], 3, true)], true),
            new waxeye.State([new waxeye.Edge(48, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 2, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("typeDef", [new waxeye.State([new waxeye.Edge(21, 1, false)], false),
            new waxeye.State([new waxeye.Edge("/", 2, true)], true),
            new waxeye.State([new waxeye.Edge(23, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("namespace", [new waxeye.State([new waxeye.Edge(42, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(21, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("start", [new waxeye.State([new waxeye.Edge(43, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("stop", [new waxeye.State([new waxeye.Edge(44, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("pause", [new waxeye.State([new waxeye.Edge(45, 1, false)], false),
            new waxeye.State([new waxeye.Edge(48, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("instancePath", [new waxeye.State([new waxeye.Edge(20, 1, false),
                new waxeye.Edge(21, 1, false)], false),
            new waxeye.State([new waxeye.Edge(["."], 2, true)], true),
            new waxeye.State([new waxeye.Edge(20, 1, false),
                new waxeye.Edge(21, 1, false)], false)], waxeye.FA.LEFT),
        ...
        new waxeye.FA("line", [new waxeye.State([new waxeye.Edge(50, 1, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 2, false)], false),
            new waxeye.State([new waxeye.Edge(49, 3, false)], true),
        ...
        new waxeye.FA("realString", [new waxeye.State([new waxeye.Edge(["\'"], 1, true),
            ...
            new waxeye.State([new waxeye.Edge(30, 1, false),
                new waxeye.Edge(26, 1, false),
                new waxeye.Edge(27, 1, false),
                new waxeye.Edge(["\'"], 2, true)], false),
            new waxeye.State([], true),
            new waxeye.State([new waxeye.Edge(30, 3, false),
                new waxeye.Edge(26, 3, false),
        ...
        new waxeye.FA("escaped", [new waxeye.State([new waxeye.Edge(["\\"], 1, false)], false),
            new waxeye.State([new waxeye.Edge(51, 2, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("singleQuoteLine", [new waxeye.State([new waxeye.Edge(57, 1, false)], false),
        ...
        new waxeye.FA("doubleQuoteLine", [new waxeye.State([new waxeye.Edge(63, 1, false)], false),
        ...
        new waxeye.FA("comment", [new waxeye.State([new waxeye.Edge("/", 1, false)], false),
            ...
            new waxeye.State([new waxeye.Edge(24, 3, false)], true),
            new waxeye.State([], true)], waxeye.FA.VOID),
        ...
        new waxeye.FA("ws", [new waxeye.State([new waxeye.Edge(["\t", " "], 0, false),
                new waxeye.Edge(47, 0, false)], true)], waxeye.FA.VOID),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(47, 1, false)], false),
