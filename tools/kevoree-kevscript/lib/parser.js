...
var Parser = (function() {
    ...
    parser.prototype = new waxeye.WaxeyeParser(0, true, [new waxeye.FA("kevScript", [new waxeye.State([new waxeye.Edge(38, 1, false)], false),
            new waxeye.State([new waxeye.Edge(1, 2, false),
                new waxeye.Edge(36, 6, true)], false),
            new waxeye.State([new waxeye.Edge(38, 3, false)], false),
            new waxeye.State([new waxeye.Edge(1, 4, false),
                new waxeye.Edge(36, 5, true)], true),
            new waxeye.State([new waxeye.Edge(38, 3, false)], false),
            new waxeye.State([new waxeye.Edge(37, 4, false)], true),
            new waxeye.State([new waxeye.Edge(37, 2, false)], false)], waxeye.FA.LEFT),
        ...
        new waxeye.FA("add", [new waxeye.State([new waxeye.Edge(26, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(38, 4, false)], false),
            new waxeye.State([new waxeye.Edge(":", 5, true)], false),
            new waxeye.State([new waxeye.Edge(38, 6, false)], false),
            new waxeye.State([new waxeye.Edge(14, 7, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("remove", [new waxeye.State([new waxeye.Edge(27, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("move", [new waxeye.State([new waxeye.Edge(28, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(38, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("attach", [new waxeye.State([new waxeye.Edge(30, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(38, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("detach", [new waxeye.State([new waxeye.Edge(31, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(13, 3, false)], false),
            new waxeye.State([new waxeye.Edge(38, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("set", [new waxeye.State([new waxeye.Edge(29, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(16, 3, false)], false),
            new waxeye.State([new waxeye.Edge("/", 4, true),
                new waxeye.Edge(38, 6, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([new waxeye.Edge(38, 6, false)], false),
            new waxeye.State([new waxeye.Edge("=", 7, true)], false),
            new waxeye.State([new waxeye.Edge(38, 8, false)], false),
            new waxeye.State([new waxeye.Edge(22, 9, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("network", [new waxeye.State([new waxeye.Edge(32, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(16, 3, false)], false),
            new waxeye.State([new waxeye.Edge(38, 4, false)], false),
            new waxeye.State([new waxeye.Edge(19, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("addBinding", [new waxeye.State([new waxeye.Edge(33, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(16, 3, false)], false),
            new waxeye.State([new waxeye.Edge(38, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("delBinding", [new waxeye.State([new waxeye.Edge(34, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(16, 3, false)], false),
            new waxeye.State([new waxeye.Edge(38, 4, false)], false),
            new waxeye.State([new waxeye.Edge(16, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("addRepo", [new waxeye.State([new waxeye.Edge(24, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(22, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("include", [new waxeye.State([new waxeye.Edge(25, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
        ...
        new waxeye.FA("typeDef", [new waxeye.State([new waxeye.Edge(18, 1, false)], false),
            ...
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("namespace", [new waxeye.State([new waxeye.Edge(35, 1, false)], false),
            new waxeye.State([new waxeye.Edge(38, 2, false)], false),
            new waxeye.State([new waxeye.Edge(18, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        ...
        new waxeye.FA("line", [new waxeye.State([new waxeye.Edge(40, 1, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 2, false)], false),
            new waxeye.State([new waxeye.Edge(39, 3, false)], true),
        ...
        new waxeye.FA("realString", [new waxeye.State([new waxeye.Edge(["\'"], 1, true),
            ...
            new waxeye.State([new waxeye.Edge(42, 5, false)], false),
            ...
            new waxeye.State([new waxeye.Edge(["\\"], 8, false),
                new waxeye.Edge(46, 10, false),
                new waxeye.Edge(["\""], 6, true)], false),
            new waxeye.State([new waxeye.Edge(44, 9, false)], false),
            new waxeye.State([new waxeye.Edge(-1, 7, false)], false),
            new waxeye.State([new waxeye.Edge(45, 11, false)], false),
            new waxeye.State([new waxeye.Edge(23, 7, false),
        ...
        new waxeye.FA("ws", [new waxeye.State([new waxeye.Edge(["\t", " "], 0, false),
                new waxeye.Edge(37, 0, false)], true)], waxeye.FA.VOID),
        new waxeye.FA("", [new waxeye.State([new waxeye.Edge(37, 1, false)], false),
