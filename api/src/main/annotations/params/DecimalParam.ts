    ...
    return function(target: any, propertyKey: string) {
        ...
        if (typeof meta.default !== 'undefined') {
            if (typeof meta.min !== 'undefined') {
                if (meta.default < meta.min) {
                    throw new Error('@DecimalParam default value must be greater or equal to \'min\'');
                }
            }

            if (typeof meta.max !== 'undefined') {
                if (meta.default > meta.max) {
                    throw new Error('@DecimalParam default value must be lesser or equal to \'max\'');
                }
            }
        }
        ...
        if (typeof meta.min !== 'undefined' && typeof meta.max !== 'undefined') {
            if (meta.min > meta.max) {
                throw new Error('@DecimalParam must define \'min\' lesser or equal to \'max\'');
            }
        }
