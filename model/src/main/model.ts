...
export class KevoreeModel extends kmf.abs.AbstractKModel<KevoreeUniverse> {
    ...
    constructor(p_manager: kmf.memory.manager.internal.KInternalDataManager) {
        ...
        tempMetaClasses[25] = kevoree.meta.MetaParam.getInstance();
        tempMetaClasses[15] = kevoree.meta.MetaPortType.getInstance();
        tempMetaClasses[1] = kevoree.meta.MetaNode.getInstance();
        tempMetaClasses[14] = kevoree.meta.MetaPort.getInstance();
        tempMetaClasses[36] = kevoree.meta.MetaMinConstraint.getInstance();
        tempMetaClasses[19] = kevoree.meta.MetaNodeType.getInstance();
        tempMetaClasses[20] = kevoree.meta.MetaGroupType.getInstance();
        tempMetaClasses[12] = kevoree.meta.MetaOutputPort.getInstance();
        tempMetaClasses[7] = kevoree.meta.MetaInstance.getInstance();
        tempMetaClasses[35] = kevoree.meta.MetaListParamType.getInstance();
        tempMetaClasses[6] = kevoree.meta.MetaValue.getInstance();
        tempMetaClasses[38] = kevoree.meta.MetaMultilineConstraint.getInstance();
        tempMetaClasses[4] = kevoree.meta.MetaNamespace.getInstance();
        tempMetaClasses[27] = kevoree.meta.MetaNumberParam.getInstance();
        tempMetaClasses[17] = kevoree.meta.MetaDeployUnit.getInstance();
        tempMetaClasses[31] = kevoree.meta.MetaStringParamType.getInstance();
        tempMetaClasses[2] = kevoree.meta.MetaChannel.getInstance();
        tempMetaClasses[16] = kevoree.meta.MetaDictionaryType.getInstance();
        tempMetaClasses[3] = kevoree.meta.MetaGroup.getInstance();
        tempMetaClasses[10] = kevoree.meta.MetaComponent.getInstance();
        tempMetaClasses[26] = kevoree.meta.MetaStringParam.getInstance();
        tempMetaClasses[37] = kevoree.meta.MetaMaxConstraint.getInstance();
        tempMetaClasses[0] = kevoree.meta.MetaModel.getInstance();
        tempMetaClasses[9] = kevoree.meta.MetaDictionary.getInstance();
        tempMetaClasses[13] = kevoree.meta.MetaFragmentDictionary.getInstance();
        tempMetaClasses[18] = kevoree.meta.MetaPreferedVersion.getInstance();
        tempMetaClasses[23] = kevoree.meta.MetaParamType.getInstance();
        tempMetaClasses[5] = kevoree.meta.MetaElement.getInstance();
        tempMetaClasses[24] = kevoree.meta.MetaAbstractConstraint.getInstance();
        tempMetaClasses[29] = kevoree.meta.MetaListParam.getInstance();
        tempMetaClasses[30] = kevoree.meta.MetaItem.getInstance();
        tempMetaClasses[8] = kevoree.meta.MetaTypeDefinition.getInstance();
        tempMetaClasses[33] = kevoree.meta.MetaBooleanParamType.getInstance();
        tempMetaClasses[34] = kevoree.meta.MetaChoiceParamType.getInstance();
        tempMetaClasses[32] = kevoree.meta.MetaNumberParamType.getInstance();
        tempMetaClasses[28] = kevoree.meta.MetaBooleanParam.getInstance();
        tempMetaClasses[21] = kevoree.meta.MetaChannelType.getInstance();
        tempMetaClasses[22] = kevoree.meta.MetaComponentType.getInstance();
        tempMetaClasses[11] = kevoree.meta.MetaInputPort.getInstance();
        var tempEnums: kmf.meta.KMetaEnum[] = new Array();
        tempEnums[0] = kevoree.meta.MetaNumberType.getInstance();
    ...
    public internalCreateObject(universe: number, time: number, uuid: number, p_clazz: kmf.meta.KMetaClass, previousUniverse: number, previousTime: number): kmf.KObject {
        ...
        switch (p_clazz.index()) {
            case 15:
                return new kevoree.impl.PortTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 1:
                return new kevoree.impl.NodeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 14:
                return new kevoree.impl.PortImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 36:
                return new kevoree.impl.MinConstraintImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 19:
                return new kevoree.impl.NodeTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 20:
                return new kevoree.impl.GroupTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 12:
                return new kevoree.impl.OutputPortImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 35:
                return new kevoree.impl.ListParamTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 6:
                return new kevoree.impl.ValueImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 38:
                return new kevoree.impl.MultilineConstraintImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 4:
                return new kevoree.impl.NamespaceImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 27:
                return new kevoree.impl.NumberParamImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 17:
                return new kevoree.impl.DeployUnitImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 31:
                return new kevoree.impl.StringParamTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 2:
                return new kevoree.impl.ChannelImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 16:
                return new kevoree.impl.DictionaryTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 3:
                return new kevoree.impl.GroupImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 10:
                return new kevoree.impl.ComponentImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 26:
                return new kevoree.impl.StringParamImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 37:
                return new kevoree.impl.MaxConstraintImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 0:
                return new kevoree.impl.ModelImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 9:
                return new kevoree.impl.DictionaryImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 13:
                return new kevoree.impl.FragmentDictionaryImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 18:
                return new kevoree.impl.PreferedVersionImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 5:
                return new kevoree.impl.ElementImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 29:
                return new kevoree.impl.ListParamImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 30:
                return new kevoree.impl.ItemImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 33:
                return new kevoree.impl.BooleanParamTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 34:
                return new kevoree.impl.ChoiceParamTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 32:
                return new kevoree.impl.NumberParamTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 28:
                return new kevoree.impl.BooleanParamImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 21:
                return new kevoree.impl.ChannelTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 22:
                return new kevoree.impl.ComponentTypeImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            case 11:
                return new kevoree.impl.InputPortImpl(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
            default:
                return new kmf.meta.impl.GenericObject(universe, time, uuid, p_clazz, this._manager, previousUniverse, previousTime);
        }
    }

    public createPortType(universe: number, time: number): kevoree.PortType {
        return <kevoree.PortType>this.create(kevoree.meta.MetaPortType.getInstance(), universe, time);
    }

    public createNode(universe: number, time: number): kevoree.Node {
        return <kevoree.Node>this.create(kevoree.meta.MetaNode.getInstance(), universe, time);
    }

    public createPort(universe: number, time: number): kevoree.Port {
        return <kevoree.Port>this.create(kevoree.meta.MetaPort.getInstance(), universe, time);
    }

    public createMinConstraint(universe: number, time: number): kevoree.MinConstraint {
        return <kevoree.MinConstraint>this.create(kevoree.meta.MetaMinConstraint.getInstance(), universe, time);
    }

    public createNodeType(universe: number, time: number): kevoree.NodeType {
        return <kevoree.NodeType>this.create(kevoree.meta.MetaNodeType.getInstance(), universe, time);
    }

    public createGroupType(universe: number, time: number): kevoree.GroupType {
        return <kevoree.GroupType>this.create(kevoree.meta.MetaGroupType.getInstance(), universe, time);
    }

    public createOutputPort(universe: number, time: number): kevoree.OutputPort {
        return <kevoree.OutputPort>this.create(kevoree.meta.MetaOutputPort.getInstance(), universe, time);
    }

    public createListParamType(universe: number, time: number): kevoree.ListParamType {
        return <kevoree.ListParamType>this.create(kevoree.meta.MetaListParamType.getInstance(), universe, time);
    }

    public createValue(universe: number, time: number): kevoree.Value {
        return <kevoree.Value>this.create(kevoree.meta.MetaValue.getInstance(), universe, time);
    }

    public createMultilineConstraint(universe: number, time: number): kevoree.MultilineConstraint {
        return <kevoree.MultilineConstraint>this.create(kevoree.meta.MetaMultilineConstraint.getInstance(), universe, time);
    }

    public createNamespace(universe: number, time: number): kevoree.Namespace {
        return <kevoree.Namespace>this.create(kevoree.meta.MetaNamespace.getInstance(), universe, time);
    }

    public createNumberParam(universe: number, time: number): kevoree.NumberParam {
        return <kevoree.NumberParam>this.create(kevoree.meta.MetaNumberParam.getInstance(), universe, time);
    }

    public createDeployUnit(universe: number, time: number): kevoree.DeployUnit {
        return <kevoree.DeployUnit>this.create(kevoree.meta.MetaDeployUnit.getInstance(), universe, time);
    }

    public createStringParamType(universe: number, time: number): kevoree.StringParamType {
        return <kevoree.StringParamType>this.create(kevoree.meta.MetaStringParamType.getInstance(), universe, time);
    }

    public createChannel(universe: number, time: number): kevoree.Channel {
        return <kevoree.Channel>this.create(kevoree.meta.MetaChannel.getInstance(), universe, time);
    }

    public createDictionaryType(universe: number, time: number): kevoree.DictionaryType {
        return <kevoree.DictionaryType>this.create(kevoree.meta.MetaDictionaryType.getInstance(), universe, time);
    }

    public createGroup(universe: number, time: number): kevoree.Group {
        return <kevoree.Group>this.create(kevoree.meta.MetaGroup.getInstance(), universe, time);
    }

    public createComponent(universe: number, time: number): kevoree.Component {
        return <kevoree.Component>this.create(kevoree.meta.MetaComponent.getInstance(), universe, time);
    }

    public createStringParam(universe: number, time: number): kevoree.StringParam {
        return <kevoree.StringParam>this.create(kevoree.meta.MetaStringParam.getInstance(), universe, time);
    }

    public createMaxConstraint(universe: number, time: number): kevoree.MaxConstraint {
        return <kevoree.MaxConstraint>this.create(kevoree.meta.MetaMaxConstraint.getInstance(), universe, time);
    }

    public createModel(universe: number, time: number): kevoree.Model {
        return <kevoree.Model>this.create(kevoree.meta.MetaModel.getInstance(), universe, time);
    }

    public createDictionary(universe: number, time: number): kevoree.Dictionary {
        return <kevoree.Dictionary>this.create(kevoree.meta.MetaDictionary.getInstance(), universe, time);
    }

    public createFragmentDictionary(universe: number, time: number): kevoree.FragmentDictionary {
        return <kevoree.FragmentDictionary>this.create(kevoree.meta.MetaFragmentDictionary.getInstance(), universe, time);
    }

    public createPreferedVersion(universe: number, time: number): kevoree.PreferedVersion {
        return <kevoree.PreferedVersion>this.create(kevoree.meta.MetaPreferedVersion.getInstance(), universe, time);
    }

    public createElement(universe: number, time: number): kevoree.Element {
        return <kevoree.Element>this.create(kevoree.meta.MetaElement.getInstance(), universe, time);
    }

    public createListParam(universe: number, time: number): kevoree.ListParam {
        return <kevoree.ListParam>this.create(kevoree.meta.MetaListParam.getInstance(), universe, time);
    }

    public createItem(universe: number, time: number): kevoree.Item {
        return <kevoree.Item>this.create(kevoree.meta.MetaItem.getInstance(), universe, time);
    }

    public createBooleanParamType(universe: number, time: number): kevoree.BooleanParamType {
        return <kevoree.BooleanParamType>this.create(kevoree.meta.MetaBooleanParamType.getInstance(), universe, time);
    }

    public createChoiceParamType(universe: number, time: number): kevoree.ChoiceParamType {
        return <kevoree.ChoiceParamType>this.create(kevoree.meta.MetaChoiceParamType.getInstance(), universe, time);
    }

    public createNumberParamType(universe: number, time: number): kevoree.NumberParamType {
        return <kevoree.NumberParamType>this.create(kevoree.meta.MetaNumberParamType.getInstance(), universe, time);
    }

    public createBooleanParam(universe: number, time: number): kevoree.BooleanParam {
        return <kevoree.BooleanParam>this.create(kevoree.meta.MetaBooleanParam.getInstance(), universe, time);
    }

    public createChannelType(universe: number, time: number): kevoree.ChannelType {
        return <kevoree.ChannelType>this.create(kevoree.meta.MetaChannelType.getInstance(), universe, time);
    }

    public createComponentType(universe: number, time: number): kevoree.ComponentType {
        return <kevoree.ComponentType>this.create(kevoree.meta.MetaComponentType.getInstance(), universe, time);
    }

    public createInputPort(universe: number, time: number): kevoree.InputPort {
        return <kevoree.InputPort>this.create(kevoree.meta.MetaInputPort.getInstance(), universe, time);
    }
...
export interface KevoreeView extends kmf.KView {
    ...
    createPortType(): kevoree.PortType;

    createNode(): kevoree.Node;

    createPort(): kevoree.Port;

    createMinConstraint(): kevoree.MinConstraint;

    createNodeType(): kevoree.NodeType;

    createGroupType(): kevoree.GroupType;

    createOutputPort(): kevoree.OutputPort;

    createListParamType(): kevoree.ListParamType;

    createValue(): kevoree.Value;

    createMultilineConstraint(): kevoree.MultilineConstraint;

    createNamespace(): kevoree.Namespace;

    createNumberParam(): kevoree.NumberParam;

    createDeployUnit(): kevoree.DeployUnit;

    createStringParamType(): kevoree.StringParamType;

    createChannel(): kevoree.Channel;

    createDictionaryType(): kevoree.DictionaryType;

    createGroup(): kevoree.Group;

    createComponent(): kevoree.Component;

    createStringParam(): kevoree.StringParam;

    createMaxConstraint(): kevoree.MaxConstraint;

    createModel(): kevoree.Model;

    createDictionary(): kevoree.Dictionary;

    createFragmentDictionary(): kevoree.FragmentDictionary;

    createPreferedVersion(): kevoree.PreferedVersion;

    createElement(): kevoree.Element;

    createListParam(): kevoree.ListParam;

    createItem(): kevoree.Item;

    createBooleanParamType(): kevoree.BooleanParamType;

    createChoiceParamType(): kevoree.ChoiceParamType;

    createNumberParamType(): kevoree.NumberParamType;

    createBooleanParam(): kevoree.BooleanParam;

    createChannelType(): kevoree.ChannelType;

    createComponentType(): kevoree.ComponentType;

    createInputPort(): kevoree.InputPort;
...
export namespace impl {
    export class KevoreeViewImpl extends kmf.abs.AbstractKView implements KevoreeView {
        ...
        public createPortType(): kevoree.PortType {
            return <kevoree.PortType>this.create(kevoree.meta.MetaPortType.getInstance());
        }

        public createNode(): kevoree.Node {
            return <kevoree.Node>this.create(kevoree.meta.MetaNode.getInstance());
        }

        public createPort(): kevoree.Port {
            return <kevoree.Port>this.create(kevoree.meta.MetaPort.getInstance());
        }

        public createMinConstraint(): kevoree.MinConstraint {
            return <kevoree.MinConstraint>this.create(kevoree.meta.MetaMinConstraint.getInstance());
        }

        public createNodeType(): kevoree.NodeType {
            return <kevoree.NodeType>this.create(kevoree.meta.MetaNodeType.getInstance());
        }

        public createGroupType(): kevoree.GroupType {
            return <kevoree.GroupType>this.create(kevoree.meta.MetaGroupType.getInstance());
        }

        public createOutputPort(): kevoree.OutputPort {
            return <kevoree.OutputPort>this.create(kevoree.meta.MetaOutputPort.getInstance());
        }

        public createListParamType(): kevoree.ListParamType {
            return <kevoree.ListParamType>this.create(kevoree.meta.MetaListParamType.getInstance());
        }

        public createValue(): kevoree.Value {
            return <kevoree.Value>this.create(kevoree.meta.MetaValue.getInstance());
        }

        public createMultilineConstraint(): kevoree.MultilineConstraint {
            return <kevoree.MultilineConstraint>this.create(kevoree.meta.MetaMultilineConstraint.getInstance());
        }

        public createNamespace(): kevoree.Namespace {
            return <kevoree.Namespace>this.create(kevoree.meta.MetaNamespace.getInstance());
        }

        public createNumberParam(): kevoree.NumberParam {
            return <kevoree.NumberParam>this.create(kevoree.meta.MetaNumberParam.getInstance());
        }

        public createDeployUnit(): kevoree.DeployUnit {
            return <kevoree.DeployUnit>this.create(kevoree.meta.MetaDeployUnit.getInstance());
        }

        public createStringParamType(): kevoree.StringParamType {
            return <kevoree.StringParamType>this.create(kevoree.meta.MetaStringParamType.getInstance());
        }

        public createChannel(): kevoree.Channel {
            return <kevoree.Channel>this.create(kevoree.meta.MetaChannel.getInstance());
        }

        public createDictionaryType(): kevoree.DictionaryType {
            return <kevoree.DictionaryType>this.create(kevoree.meta.MetaDictionaryType.getInstance());
        }

        public createGroup(): kevoree.Group {
            return <kevoree.Group>this.create(kevoree.meta.MetaGroup.getInstance());
        }

        public createComponent(): kevoree.Component {
            return <kevoree.Component>this.create(kevoree.meta.MetaComponent.getInstance());
        }

        public createStringParam(): kevoree.StringParam {
            return <kevoree.StringParam>this.create(kevoree.meta.MetaStringParam.getInstance());
        }

        public createMaxConstraint(): kevoree.MaxConstraint {
            return <kevoree.MaxConstraint>this.create(kevoree.meta.MetaMaxConstraint.getInstance());
        }

        public createModel(): kevoree.Model {
            return <kevoree.Model>this.create(kevoree.meta.MetaModel.getInstance());
        }

        public createDictionary(): kevoree.Dictionary {
            return <kevoree.Dictionary>this.create(kevoree.meta.MetaDictionary.getInstance());
        }

        public createFragmentDictionary(): kevoree.FragmentDictionary {
            return <kevoree.FragmentDictionary>this.create(kevoree.meta.MetaFragmentDictionary.getInstance());
        }

        public createPreferedVersion(): kevoree.PreferedVersion {
            return <kevoree.PreferedVersion>this.create(kevoree.meta.MetaPreferedVersion.getInstance());
        }

        public createElement(): kevoree.Element {
            return <kevoree.Element>this.create(kevoree.meta.MetaElement.getInstance());
        }

        public createListParam(): kevoree.ListParam {
            return <kevoree.ListParam>this.create(kevoree.meta.MetaListParam.getInstance());
        }

        public createItem(): kevoree.Item {
            return <kevoree.Item>this.create(kevoree.meta.MetaItem.getInstance());
        }

        public createBooleanParamType(): kevoree.BooleanParamType {
            return <kevoree.BooleanParamType>this.create(kevoree.meta.MetaBooleanParamType.getInstance());
        }

        public createChoiceParamType(): kevoree.ChoiceParamType {
            return <kevoree.ChoiceParamType>this.create(kevoree.meta.MetaChoiceParamType.getInstance());
        }

        public createNumberParamType(): kevoree.NumberParamType {
            return <kevoree.NumberParamType>this.create(kevoree.meta.MetaNumberParamType.getInstance());
        }

        public createBooleanParam(): kevoree.BooleanParam {
            return <kevoree.BooleanParam>this.create(kevoree.meta.MetaBooleanParam.getInstance());
        }

        public createChannelType(): kevoree.ChannelType {
            return <kevoree.ChannelType>this.create(kevoree.meta.MetaChannelType.getInstance());
        }

        public createComponentType(): kevoree.ComponentType {
            return <kevoree.ComponentType>this.create(kevoree.meta.MetaComponentType.getInstance());
        }

        public createInputPort(): kevoree.InputPort {
            return <kevoree.InputPort>this.create(kevoree.meta.MetaInputPort.getInstance());
        }
